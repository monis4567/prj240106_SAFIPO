...
wd05 <- "output05_ddpcr_results_Neomel"
#paste dirs together
...
# subset the data frame to only contain the 'Neomel' target
df_ddP <- df_ddP[(df_ddP$Target=="Neomel"),]
#unique(df_ddP$file)
...
write.csv(df_ddP03, 
          file = paste0(wd00_out02,"/df_ddP03_Neomel_dil1to1.csv") )
...
outfl <- paste0(wd00_wd05,"/Fig04b_copies_per_filtered_liter_compared_with_extract_v01_Neomel.png")
...
# define the output file name
outfl <- paste0(wd00_wd05,"/Fig04_copies_per_filtered_liter_v01_Neomel.png")
#set variable to define if figures are to be saved
bSaveFigures<-T
# save the figure if the above 'bSaveFigures' is TRUE
if(bSaveFigures==T){
...
# define the output file name
outfl <- paste0(wd00_wd05,"/Fig06_copies_per_uL_per_filtered_liter_v01_Neomel.png")
#set variable to define if figures are to be saved
bSaveFigures<-T
# save the figure if the above 'bSaveFigures' is TRUE
if(bSaveFigures==T){
...
# define the output file name
outfl <- paste0(wd00_wd05,"/Fig07_eDNA_copies_per_filtered_liter_v01_Neomel.png")
#set variable to define if figures are to be saved
bSaveFigures<-T
# save the figure if the above 'bSaveFigures' is TRUE
if(bSaveFigures==T){
...
# define the output file name
outfl <- paste0(wd00_wd05,"/Fig07_eDNA_copies_per_filtered_liter_Neomel_v02.png")
#set variable to define if figures are to be saved
bSaveFigures<-T
# save the figure if the above 'bSaveFigures' is TRUE
if(bSaveFigures==T){
